...
Completion marker: `DAILY_OFFICE_HANDOFF_DIGEST_BROWSER_QA_RECHECK_BLOCKED_20260706_SAFE_PREFLIGHT_ONLY`

This blocker note records the 2026-07-06 rerun attempt for the Daily Office Handoff Digest dashboard browser QA. The recheck stopped at the app availability preflight because `http://localhost:3000/api/health` returned a connection failure in this Codex session.

The earlier passed browser QA evidence in `docs/DAILY_OFFICE_HANDOFF_DIGEST_BROWSER_QA_EVIDENCE_20260705.md` remains the completed QA record for the Daily Office Handoff Digest dashboard card. The earlier 2026-07-05 recheck blocker in `docs/DAILY_OFFICE_HANDOFF_DIGEST_BROWSER_QA_RECHECK_20260705_BLOCKED.md` remains historical blocker evidence. This note only records that the 2026-07-06 rerun could not start because the local app target was unavailable.
...
`BROWSER_QA_RECHECK_BLOCKED_20260706; HEALTH_TARGET_UNAVAILABLE; BROWSER_NOT_OPENED; PRIOR_PASS_REMAINS_CURRENT_COMPLETED_QA_RECORD; PRODUCTION_NOT_ACCESSED; READ_ONLY_PREFLIGHT_ONLY`
...
| Active parish label behavior confirmed | `NOT CONFIRMED` | Not checked because no dashboard session was opened |
...
- `docs/DAILY_OFFICE_HANDOFF_DIGEST_BROWSER_QA_RECHECK_20260705_BLOCKED.md` remains historical evidence that the previous recheck attempt also stopped before browser access.
...
- This file records only the 2026-07-06 unavailable-target recheck blocker.
...
```json
{
  ...
  "decisionState": "BROWSER_QA_RECHECK_BLOCKED_20260706; HEALTH_TARGET_UNAVAILABLE; BROWSER_NOT_OPENED; PRIOR_PASS_REMAINS_CURRENT_COMPLETED_QA_RECORD; PRODUCTION_NOT_ACCESSED; READ_ONLY_PREFLIGHT_ONLY",
  ...
  "previousBlockedRecheck": "docs/DAILY_OFFICE_HANDOFF_DIGEST_BROWSER_QA_RECHECK_20260705_BLOCKED.md",
  "missingLabels": [
...
Current status: `DAILY_OFFICE_HANDOFF_DIGEST_BROWSER_QA_RECHECK_BLOCKED_20260706_SAFE_PREFLIGHT_ONLY`

The 2026-07-06 recheck could not start because the local app target was unavailable at `/api/health`. No browser QA was opened. The earlier passed browser QA evidence remains the current completed evidence for the Daily Office Handoff Digest dashboard card.
