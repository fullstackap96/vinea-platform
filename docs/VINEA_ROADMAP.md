...
Latest release-candidate rollout evidence and repair: original exact-head CI and authenticated read-only smoke passed staff sign-in, active-parish switching, Onboarding, Imports, People duplicate review, and Communications Center. Immutable follow-up commit `19b601df046de06a6a52f214e24adcdeba05b577` aligned health with Vinea's established trusted Vercel-origin policy and preserved fail-closed exact-HTTPS parsing. The complete 15-check local gate passed with `832` files / `3,546` tests and a credential-free `56`-page build. Repaired Preview deployment `dpl_12zYEf2RQE7W2xsGhPgeEmy1LFa9` is `READY`, runtime health returned `200`, and the requested staff smoke passed again without writes. Next priority is clean-checkout CI attribution for the latest evidence head and human PR review. Merge, production deployment, production RLS, monitoring, exports, public-intake routing, customer-facing AI, and public trust claims remain separately gated.
