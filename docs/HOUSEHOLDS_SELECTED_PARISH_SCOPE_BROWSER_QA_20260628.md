# Households Selected-Parish Scope Browser QA
...
This verification checked that the Households page selected-parish scope label follows the active parish selector after switching between authorized shared-QA parish fixtures.
...
| Households URL | `/dashboard/households` |
...
| Households page loaded at `/dashboard/households` | Passed |
| Initial Households scope label displayed the current active parish | Passed: `Households are scoped to Vinea QA Google Calendar Parish A.` |
...
| Selecting Parish B updated the Households scope label | Passed: `Households are scoped to Vinea QA Google Calendar Parish B.` |
| Selecting Parish A updated the selected option | Passed: `Vinea QA Google Calendar Parish A` |
| Selecting Parish A updated the Households scope label | Passed: `Households are scoped to Vinea QA Google Calendar Parish A.` |
| Page stayed on `/dashboard/households` | Passed |
...
```json
{
  ...
  "householdsScopeLabels": {
    "initial": "Households are scoped to Vinea QA Google Calendar Parish A.",
    "afterSelectingParishB": "Households are scoped to Vinea QA Google Calendar Parish B.",
    "afterSelectingParishA": "Households are scoped to Vinea QA Google Calendar Parish A."
  },
  "selectedOptions": {
...
- This QA confirmed selected-parish context display only. It did not promote production RLS or change Households visibility behavior.

## Outcome

Current status: `HOUSEHOLDS_SELECTED_PARISH_SCOPE_BROWSER_QA_COMPLETE_SHARED_QA_ONLY`

The Households selected-parish scope label follows authorized parish switching in the shared-QA browser path.
