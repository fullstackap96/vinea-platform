...
- Parent/base commit before this family portal upload client-recovery slice: `a3500e99ed44c7dfa2e7219a01680c217dc64f16`
- Immutable implementation commit: `a4f66fbf64328113a43586a662169970569f38f6`
- Release-source aggregate SHA-256: `D65A37DF88E420CF5516CD3C3F62585EC96739CF1B987FF529F97CAE1BDD3B18`
- Source file count: `1464`
- Tracked or staged source files: `1464`
...
This gives reviewers a tamper-evident identity for the exact release source surface, but the aggregate alone does not replace an immutable Git commit. Commit `a4f66fbf64328113a43586a662169970569f38f6` on `codex/release-candidate-20260711` is the immutable family portal upload client-recovery implementation binding for this aggregate. The complete 15-check local release gate passed in `276.8` seconds with zero secret findings across `2,133` files, zero vulnerabilities, both TypeScript scopes, lint, `828` test files / `3,525` tests, and the credential-free `56`-page build. Clean-checkout GitHub Actions, actual PR check attribution, and a correctly configured protected-preview smoke remain pending. Before any production deployment, the manifest and release-readiness runner must pass again against the exact approved deployment commit. Excluded non-release artifacts may remain outside the commit and do not authorize production.
