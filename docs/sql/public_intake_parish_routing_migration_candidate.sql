-- NON-APPLIED CANDIDATE ONLY.
-- Do not copy this file into supabase/migrations until the public intake parish
-- routing strategy approval gates pass.
--
-- Strategy doc:
-- docs/PUBLIC_INTAKE_PARISH_ROUTING_STRATEGY.md
--
-- Runtime behavior must not change from this file. Operational RLS must not be
-- changed until a future approved migration phase.
