-- MIGRATION CANDIDATE ONLY - NOT A SUPABASE MIGRATION.
-- Do not place this file in supabase/migrations until the disposable QA
-- checklist has passed and the migration is explicitly approved.
--
-- Candidate purpose:
