...
const evidencePath = join(
  process.cwd(),
  'docs',
  'NOTIFICATIONS_CENTER_SELECTED_PARISH_SCOPE_BROWSER_QA_20260629.md'
)

describe('Notifications Center selected parish scope browser QA evidence', () => {
  it('records completed shared-QA browser verification for Notifications Center parish scope labels', () => {
    ...
    for (const expected of [
      ...
      'checks.schema: true',
      'Scoped to Vinea QA Google Calendar Parish A',
      'Scoped to Vinea QA Google Calendar Parish B',
      'NOTIFICATIONS_CENTER_SELECTED_PARISH_SCOPE_BROWSER_QA_COMPLETE_SHARED_QA_ONLY',
    ]) {
