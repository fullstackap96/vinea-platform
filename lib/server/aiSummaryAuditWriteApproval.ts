export const AI_SUMMARY_AUDIT_WRITE_FLAG = 'VINEA_AI_SUMMARY_AUDIT_WRITE'
export const AI_SUMMARY_AUDIT_WRITE_ACK = 'VINEA_AI_SUMMARY_AUDIT_WRITE_ACK'
export const AI_SUMMARY_AUDIT_WRITE_ENABLED_VALUE = 'ENABLED'
export const AI_SUMMARY_AUDIT_WRITE_ACK_VALUE = 'APPROVED_AI_SUMMARY_AUDIT_WRITE'

export type AiSummaryAuditWriteApprovalSourceValidation = {
  readonly ok: boolean
...
export function validateFutureAiSummaryAuditWriteSource(
  source: string
): AiSummaryAuditWriteApprovalSourceValidation {
  const requiredMarkers = [
    ...
    'safetyChain.auditPreparation.futureAuditEvent',
  ...
  expectBefore(source, 'await writeAuditEvent', "error: 'ai_retrieval_unavailable'", orderingFailures)
