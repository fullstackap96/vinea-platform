...
const evidencePath = join(
  process.cwd(),
  'docs',
  'PEOPLE_SELECTED_PARISH_SCOPE_BROWSER_QA_20260628.md'
)

describe('people selected parish scope browser QA evidence', () => {
  it('records completed shared-QA browser verification for People parish scope labels', () => {
    ...
    for (const expected of [
      ...
      'checks.schema: true',
      'People are scoped to Vinea QA Google Calendar Parish A.',
      'People are scoped to Vinea QA Google Calendar Parish B.',
      'PEOPLE_SELECTED_PARISH_SCOPE_BROWSER_QA_COMPLETE_SHARED_QA_ONLY',
    ]) {
